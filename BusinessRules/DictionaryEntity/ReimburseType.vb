...
Public Class ReimburseType
    Private moReimburseTypeCommand As SqlCommand
    ...
    Public Function GetReimburseType(ByVal Condition As String) As DataSet
        Dim dstResult As DataSet = New DataSet("ReimburseTypeDST")
        ...
        da.SelectCommand = New SqlCommand("dbo.PFetchReimburseType", moConnection)
        ...
        moReimburseTypeCommand = da.SelectCommand

        Try
            da.Fill(dstResult, "TReimburseType")
        Catch ex As System.Exception
            Throw ex
        End Try
    ...
    Public Function UpdateReimburseType(ByVal dstCommit As DataSet) As Int32
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        ...
        If moReimburseTypeCommand Is Nothing Then
            da.SelectCommand = New SqlCommand("dbo.PFetchReimburseType", moConnection)
            da.SelectCommand.Transaction = moTransaction
            da.SelectCommand.CommandType = CommandType.StoredProcedure
            da.SelectCommand.Parameters.Add("@Condition", SqlDbType.NVarChar, 1000, "Condition")
        ...
        Else
            moReimburseTypeCommand.Connection = moConnection
            da.SelectCommand = moReimburseTypeCommand
        End If
        ...
        Try
            Return da.Update(dstCommit, "TReimburseType")
        Catch ex As System.Exception
            Throw ex
        End Try
    End Function
