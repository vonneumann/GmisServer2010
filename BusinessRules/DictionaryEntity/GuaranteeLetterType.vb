...
Public Class GuaranteeLetterType
    Private moGuaranteeLetterTypeCommand As SqlCommand
    ...
    Public Function GetGuaranteeLetterType(ByVal Condition As String) As DataSet
        Dim dstResult As DataSet = New DataSet("GuaranteeLetterTypeDST")
        ...
        da.SelectCommand = New SqlCommand("dbo.PFetchGuaranteeLetterType", moConnection)
        ...
        moGuaranteeLetterTypeCommand = da.SelectCommand

        Try
            da.Fill(dstResult, "TGuaranteeLetterType")
        Catch ex As System.Exception
            Throw ex
        End Try
    ...
    Public Function UpdateGuaranteeLetterType(ByVal dstCommit As DataSet) As Int32
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        ...
        If moGuaranteeLetterTypeCommand Is Nothing Then
            da.SelectCommand = New SqlCommand("dbo.PFetchGuaranteeLetterType", moConnection)
            da.SelectCommand.Transaction = moTransaction
            da.SelectCommand.CommandType = CommandType.StoredProcedure
            da.SelectCommand.Parameters.Add("@Condition", SqlDbType.NVarChar, 1000, "Condition")
        ...
        Else
            moGuaranteeLetterTypeCommand.Connection = moConnection
            da.SelectCommand = moGuaranteeLetterTypeCommand
        End If
        ...
        Try
            Return da.Update(dstCommit, "TGuaranteeLetterType")
        Catch ex As System.Exception
            Throw ex
        End Try
    End Function
