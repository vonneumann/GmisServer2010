...
Public Class LoanType
    Private moLoanTypeCommand As SqlCommand
    ...
    Public Function GetLoanType(ByVal LoanTypeNo As String) As DataSet
        Dim dstResult As DataSet = New DataSet("LoanTypeDST")
        ...
        da.SelectCommand = New SqlCommand("dbo.PFetchLoanType", moConnection)
        ...
        da.SelectCommand.Parameters("@Condition").Value = LoanTypeNo

        moLoanTypeCommand = da.SelectCommand

        Try
            da.Fill(dstResult, "TLoanType")
        Catch ex As System.Exception
            Throw ex
        End Try
    ...
    Public Function UpdateLoanType(ByVal dstCommit As DataSet) As Int32
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        ...
        If moLoanTypeCommand Is Nothing Then
            da.SelectCommand = New SqlCommand("dbo.PFetchLoanType", moConnection)
            da.SelectCommand.Transaction = moTransaction
            da.SelectCommand.CommandType = CommandType.StoredProcedure
            da.SelectCommand.Parameters.Add("@Condition", SqlDbType.NVarChar, 1000, "Condition")
        ...
        Else
            moLoanTypeCommand.Connection = moConnection
            da.SelectCommand = moLoanTypeCommand
        End If
        ...
        Try
            Return da.Update(dstCommit, "TLoanType")
        Catch ex As System.Exception
            Throw ex
        End Try
    End Function
