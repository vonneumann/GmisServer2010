...
Public Class RecordType
    Private moRecordTypeCommand As SqlCommand
    ...
    Public Function GetRecordType(ByVal RecordTypeNo As String) As DataSet
        Dim dstResult As DataSet = New DataSet("RecordTypeDST")
        ...
        da.SelectCommand = New SqlCommand("dbo.PFetchRecordType", moConnection)
        ...
        da.SelectCommand.Parameters("@Condition").Value = RecordTypeNo

        moRecordTypeCommand = da.SelectCommand

        Try
            da.Fill(dstResult, "TRecordType")
        Catch ex As System.Exception
            Throw ex
        End Try
    ...
    Public Function UpdateRecordType(ByVal dstCommit As DataSet) As Int32
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        ...
        If moRecordTypeCommand Is Nothing Then
            da.SelectCommand = New SqlCommand("dbo.PFetchRecordType", moConnection)
            da.SelectCommand.Transaction = moTransaction
            da.SelectCommand.CommandType = CommandType.StoredProcedure
            da.SelectCommand.Parameters.Add("@Condition", SqlDbType.NVarChar, 1000, "Condition")
        ...
        Else
            moRecordTypeCommand.Connection = moConnection
            da.SelectCommand = moRecordTypeCommand
        End If
        ...
        Try
            Return da.Update(dstCommit, "TRecordType")
        Catch ex As System.Exception
            Throw ex
        End Try
    End Function
