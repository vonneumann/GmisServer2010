...
Public Class LoanForm
    Private moLoanFormCommand As SqlCommand
    ...
    Public Function GetLoanForm(ByVal LoanFormNo As String) As DataSet
        Dim dstResult As DataSet = New DataSet("LoanFormDST")
        ...
        da.SelectCommand = New SqlCommand("dbo.PFetchLoanForm", moConnection)
        ...
        da.SelectCommand.Parameters("@Condition").Value = LoanFormNo

        moLoanFormCommand = da.SelectCommand

        Try
            da.Fill(dstResult, "TLoanForm")
        Catch ex As System.Exception
            Throw ex
        End Try
    ...
    Public Function UpdateLoanForm(ByVal dstCommit As DataSet) As Int32
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        ...
        If moLoanFormCommand Is Nothing Then
            da.SelectCommand = New SqlCommand("dbo.PFetchLoanForm", moConnection)
            da.SelectCommand.Transaction = moTransaction
            da.SelectCommand.CommandType = CommandType.StoredProcedure
            da.SelectCommand.Parameters.Add("@Condition", SqlDbType.NVarChar, 1000, "Condition")
        ...
        Else
            moLoanFormCommand.Connection = moConnection
            da.SelectCommand = moLoanFormCommand
        End If
        ...
        Try
            Return da.Update(dstCommit, "TLoanForm")
        Catch ex As System.Exception
            Throw ex
        End Try
    End Function
