...
Public Class InvestForm
    Private moInvestFormCommand As SqlCommand
    ...
    Public Function GetInvestForm(ByVal InvestFormNo As String) As DataSet
        Dim dstResult As DataSet = New DataSet("InvestFormDST")
        ...
        da.SelectCommand = New SqlCommand("dbo.PFetchInvestForm", moConnection)
        ...
        da.SelectCommand.Parameters("@Condition").Value = InvestFormNo

        moInvestFormCommand = da.SelectCommand

        Try
            da.Fill(dstResult, "TInvestForm")
        Catch ex As System.Exception
            Throw ex
        End Try
    ...
    Public Function UpdateInvestForm(ByVal dstCommit As DataSet) As Int32
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        ...
        If moInvestFormCommand Is Nothing Then
            da.SelectCommand = New SqlCommand("dbo.PFetchInvestForm", moConnection)
            da.SelectCommand.Transaction = moTransaction
            da.SelectCommand.CommandType = CommandType.StoredProcedure
            da.SelectCommand.Parameters.Add("@Condition", SqlDbType.NVarChar, 1000, "Condition")
        ...
        Else
            moInvestFormCommand.Connection = moConnection
            da.SelectCommand = moInvestFormCommand
        End If
        ...
        Try
            Return da.Update(dstCommit, "TInvestForm")
        Catch ex As System.Exception
            Throw ex
        End Try
    End Function
