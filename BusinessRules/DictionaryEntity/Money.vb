...
Public Class Money
    Private moMoneyCommand As SqlCommand
    ...
    Public Function GetMoneyInfo(ByVal MoneyNo As String) As DataSet
        Dim dstResult As DataSet = New DataSet("MoneyDST")
        ...
        da.SelectCommand = New SqlCommand("dbo.getMoneyInfo", moConnection)
        ...
        da.SelectCommand.Parameters("@Condition").Value = MoneyNo

        moMoneyCommand = da.SelectCommand

        Try
            da.Fill(dstResult, "TMoney")
        Catch ex As System.Exception
            Throw ex
        End Try
    ...
    Public Function UpdateMoney(ByVal dstCommit As DataSet) As Int32
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        ...
        If moMoneyCommand Is Nothing Then
            da.SelectCommand = New SqlCommand("dbo.getMoneyInfo", moConnection)
            da.SelectCommand.Transaction = moTransaction
            da.SelectCommand.CommandType = CommandType.StoredProcedure
            da.SelectCommand.Parameters.Add("@Condition", SqlDbType.NVarChar, 1000, "Condition")
        ...
        Else
            moMoneyCommand.Connection = moConnection
            da.SelectCommand = moMoneyCommand
        End If
        ...
        Try
            Return da.Update(dstCommit, "TMoney")
        Catch ex As System.Exception
            Throw ex
        End Try
    End Function
