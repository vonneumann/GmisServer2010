...
Public Class CorporationType
    Private moCorporationTypeCommand As SqlCommand
    ...
    Public Function GetCorporationType(ByVal CorporationTypeNo As String) As DataSet
        Dim dstResult As DataSet = New DataSet("CorporationTypeDST")
        ...
        da.SelectCommand = New SqlCommand("dbo.PFetchCorporationType", moConnection)
        ...
        da.SelectCommand.Parameters("@Condition").Value = CorporationTypeNo

        moCorporationTypeCommand = da.SelectCommand

        Try
            da.Fill(dstResult, "TCorporationType")
        Catch ex As System.Exception
            Throw ex
        End Try
    ...
    Public Function UpdateCorporationType(ByVal dstCommit As DataSet) As Int32
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        ...
        If moCorporationTypeCommand Is Nothing Then
            da.SelectCommand = New SqlCommand("dbo.PFetchCorporationType", moConnection)
            da.SelectCommand.Transaction = moTransaction
            da.SelectCommand.CommandType = CommandType.StoredProcedure
            da.SelectCommand.Parameters.Add("@Condition", SqlDbType.NVarChar, 1000, "Condition")
        ...
        Else
            moCorporationTypeCommand.Connection = moConnection
            da.SelectCommand = moCorporationTypeCommand
        End If
        ...
        Try
            Return da.Update(dstCommit, "TCorporationType")
        Catch ex As System.Exception
            Throw ex
        End Try
    End Function
