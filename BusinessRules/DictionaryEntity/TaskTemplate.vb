...
Public Class TaskTemplate
    Private moTaskTemplateCommand As SqlCommand
    ...
    Public Function GetTaskTemplate(ByVal TaskID As String) As DataSet
        Dim dstResult As DataSet = New DataSet("TaskTemplateDST")
        ...
        da.SelectCommand = New SqlCommand("dbo.PFetchTaskTemplate", moConnection)
        ...
        da.SelectCommand.Parameters("@Condition").Value = TaskID

        moTaskTemplateCommand = da.SelectCommand

        Try
            da.Fill(dstResult, "TTaskTemplate")
        Catch ex As System.Exception
            Throw ex
        End Try
    ...
    Public Function UpdateTaskTemplate(ByVal dstCommit As DataSet) As Int32
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        ...
        If moTaskTemplateCommand Is Nothing Then
            da.SelectCommand = New SqlCommand("dbo.PFetchTaskTemplate", moConnection)
            da.SelectCommand.Transaction = moTransaction
            da.SelectCommand.CommandType = CommandType.StoredProcedure
            da.SelectCommand.Parameters.Add("@Condition", SqlDbType.NVarChar, 1000, "Condition")
        ...
        Else
            moTaskTemplateCommand.Connection = moConnection
            da.SelectCommand = moTaskTemplateCommand
        End If
        ...
        Try
            Return da.Update(dstCommit, "TTaskTemplate")
        Catch ex As System.Exception
            Throw ex
        End Try
    End Function
