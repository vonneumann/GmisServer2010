...
Public Class IndustryType
    Private moIndustryTypeCommand As SqlCommand
    ...
    Public Function GetIndustryType(ByVal IndustryTypeNo As String) As DataSet
        Dim dstResult As DataSet = New DataSet("IndustryTypeDST")
        ...
        da.SelectCommand = New SqlCommand("dbo.PFetchIndustryType", moConnection)
        ...
        da.SelectCommand.Parameters("@Condition").Value = IndustryTypeNo

        moIndustryTypeCommand = da.SelectCommand

        Try
            da.Fill(dstResult, "TIndustryType")
        Catch ex As System.Exception
            Throw ex
        End Try
    ...
    Public Function UpdateIndustryType(ByVal dstCommit As DataSet) As Int32
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        ...
        If moIndustryTypeCommand Is Nothing Then
            da.SelectCommand = New SqlCommand("dbo.PFetchIndustryType", moConnection)
            da.SelectCommand.Transaction = moTransaction
            da.SelectCommand.CommandType = CommandType.StoredProcedure
            da.SelectCommand.Parameters.Add("@Condition", SqlDbType.NVarChar, 1000, "Condition")
        ...
        Else
            moIndustryTypeCommand.Connection = moConnection
            da.SelectCommand = moIndustryTypeCommand
        End If
        ...
        Try
            Return da.Update(dstCommit, "TIndustryType")
        Catch ex As System.Exception
            Throw ex
        End Try
    End Function
