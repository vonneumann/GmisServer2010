...
Public Class RefundType
    Private moRefundTypeCommand As SqlCommand
    ...
    Public Function GetRefundType(ByVal RefundTypeNo As String) As DataSet
        Dim dstResult As DataSet = New DataSet("RefundTypeDST")
        ...
        da.SelectCommand = New SqlCommand("dbo.PFetchRefundType", moConnection)
        ...
        da.SelectCommand.Parameters("@Condition").Value = RefundTypeNo

        moRefundTypeCommand = da.SelectCommand

        Try
            da.Fill(dstResult, "TRefundType")
        Catch ex As System.Exception
            Throw ex
        End Try
    ...
    Public Function UpdateRefundType(ByVal dstCommit As DataSet) As Int32
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        ...
        If moRefundTypeCommand Is Nothing Then
            da.SelectCommand = New SqlCommand("dbo.PFetchRefundType", moConnection)
            da.SelectCommand.Transaction = moTransaction
            da.SelectCommand.CommandType = CommandType.StoredProcedure
            da.SelectCommand.Parameters.Add("@Condition", SqlDbType.NVarChar, 1000, "Condition")
        ...
        Else
            moRefundTypeCommand.Connection = moConnection
            da.SelectCommand = moRefundTypeCommand
        End If
        ...
        Try
            Return da.Update(dstCommit, "TRefundType")
        Catch ex As System.Exception
            Throw ex
        End Try
    End Function
