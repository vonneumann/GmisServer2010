...
Public Class RiskClass
    Private moRiskClassCommand As SqlCommand
    ...
    Public Function GetRiskClass(ByVal RiskClassNo As String) As DataSet
        Dim dstResult As DataSet = New DataSet("RiskClassDST")
        Dim da As SqlDataAdapter = New SqlDataAdapter()

        If RiskClassNo Is Nothing Then
            RiskClassNo = "NULL"
        End If
        ...
        da.SelectCommand = New SqlCommand("dbo.PFetchRiskClass", moConnection)
        ...
        da.SelectCommand.Parameters("@Condition").Value = RiskClassNo

        moRiskClassCommand = da.SelectCommand

        Try
            da.Fill(dstResult, "TRiskClass")
        Catch ex As System.Exception
            Throw ex
        End Try
    ...
    Public Function UpdateRiskClass(ByVal dstCommit As DataSet) As Int32
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        ...
        If moRiskClassCommand Is Nothing Then
            da.SelectCommand = New SqlCommand("dbo.PFetchRiskClass", moConnection)
            da.SelectCommand.Transaction = moTransaction
            da.SelectCommand.CommandType = CommandType.StoredProcedure
            da.SelectCommand.Parameters.Add("@Condition", SqlDbType.NVarChar, 1000, "Condition")
        ...
        Else
            moRiskClassCommand.Connection = moConnection
            da.SelectCommand = moRiskClassCommand
        End If
        ...
        Try
            Return da.Update(dstCommit, "TRiskClass")
        Catch ex As System.Exception
            Throw ex
        End Try
    End Function
