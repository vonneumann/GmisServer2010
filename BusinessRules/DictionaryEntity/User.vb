...
Public Class User
    Private moUserCommand As SqlCommand
    ...
    Public Function GetUser(ByVal UserID As String) As DataSet
        Dim dstResult As DataSet = New DataSet("UserDST")
        ...
        da.SelectCommand = New SqlCommand("dbo.PFetchUser", moConnection)
        ...
        da.SelectCommand.Parameters("@Condition").Value = UserID

        moUserCommand = da.SelectCommand

        Try
            da.Fill(dstResult, "TUser")
        Catch ex As System.Exception
            Throw ex
        End Try
    ...
    Public Function UpdateUser(ByVal dstCommit As DataSet) As Int32
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        ...
        If moUserCommand Is Nothing Then
            da.SelectCommand = New SqlCommand("dbo.PFetchUser", moConnection)
            da.SelectCommand.Transaction = moTransaction
            da.SelectCommand.CommandType = CommandType.StoredProcedure
            da.SelectCommand.Parameters.Add("@Condition", SqlDbType.NVarChar, 1000, "Condition")
        ...
        Else
            moUserCommand.Connection = moConnection
            da.SelectCommand = moUserCommand
        End If
        ...
        Try
            Return da.Update(dstCommit, "TUser")
        Catch ex As System.Exception
            Throw ex
        End Try
    End Function
