...
Public Class TerminateType
    Private moTerminateTypeCommand As SqlCommand
    ...
    Public Function GetTerminateType(ByVal TerminateTypeNo As String) As DataSet
        Dim dstResult As DataSet = New DataSet("TerminateTypeDST")
        ...
        da.SelectCommand = New SqlCommand("dbo.PFetchTerminateType", moConnection)
        ...
        da.SelectCommand.Parameters("@Condition").Value = TerminateTypeNo

        moTerminateTypeCommand = da.SelectCommand

        Try
            da.Fill(dstResult, "TTerminateType")
        Catch ex As System.Exception
            Throw ex
        End Try
    ...
    Public Function UpdateTerminateType(ByVal dstCommit As DataSet) As Int32
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        ...
        If moTerminateTypeCommand Is Nothing Then
            da.SelectCommand = New SqlCommand("dbo.PFetchTerminateType", moConnection)
            da.SelectCommand.Transaction = moTransaction
            da.SelectCommand.CommandType = CommandType.StoredProcedure
            da.SelectCommand.Parameters.Add("@Condition", SqlDbType.NVarChar, 1000, "Condition")
        ...
        Else
            moTerminateTypeCommand.Connection = moConnection
            da.SelectCommand = moTerminateTypeCommand
        End If
        ...
        Try
            Return da.Update(dstCommit, "TTerminateType")
        Catch ex As System.Exception
            Throw ex
        End Try
    End Function
