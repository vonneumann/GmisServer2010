...
Public Class Branch
    Private moBranchCommand As SqlCommand
    ...
    Public Function GetBranch(ByVal BranchNo As String) As DataSet
        Dim dstResult As DataSet = New DataSet("BranchDST")
        ...
        da.SelectCommand = New SqlCommand("dbo.PFetchBranch", moConnection)
        ...
        da.SelectCommand.Parameters("@Condition").Value = BranchNo

        moBranchCommand = da.SelectCommand

        Try
            da.Fill(dstResult, "TBranch")
        Catch ex As System.Exception
            Throw ex
        End Try
    ...
    Public Function UpdateBranch(ByVal dstCommit As DataSet) As Int32
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        ...
        If moBranchCommand Is Nothing Then
            da.SelectCommand = New SqlCommand("dbo.PFetchBranch", moConnection)
            da.SelectCommand.Transaction = moTransaction
            da.SelectCommand.CommandType = CommandType.StoredProcedure
            da.SelectCommand.Parameters.Add("@Condition", SqlDbType.NVarChar, 1000, "Condition")
        ...
        Else
            moBranchCommand.Connection = moConnection
            da.SelectCommand = moBranchCommand
        End If
        ...
        Try
            Return da.Update(dstCommit, "TBranch")
        Catch ex As System.Exception
            Throw ex
        End Try
    End Function
