...
Public Class ImplIsDespositFeeEx
    ...
    Public Function UseFlowTools(ByVal workFlowID As String, ByVal projectID As String, ByVal taskID As String, ByVal finishedFlag As String, ByVal userID As String) Implements IFlowTools.UseFlowTools
        ...
        strSql = "{project_code=" & "'" & projectID & "'" & " and task_id='IsValidateDepositFeeEx'}"
        ...
        If TotalTrialFeeIncome < TrialFeePayout Then
            For i = 0 To dsTempTaskTrans.Tables(0).Rows.Count - 1
                If dsTempTaskTrans.Tables(0).Rows(i).Item("next_task") = "DepositFeeCharge" Then
        ...
        Else '确认收费为:0或者payout=income,则不启动收费任务了
            ...
            '不启动收费任务,则把该任务置为.F.
            strSql = "{project_code=" & "'" & projectID & "'" & " and task_id ='DepositFeeCharge'}"
