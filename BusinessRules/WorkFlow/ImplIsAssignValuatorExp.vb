...
'判断反担保物是否需要分配评估师
Public Class ImplIsAssignValuatorExp
    ...
    Public Function UseFlowTools(ByVal workFlowID As String, ByVal projectID As String, ByVal taskID As String, ByVal finishedFlag As String, ByVal userID As String) Implements IFlowTools.UseFlowTools
        ...
        If isAssignValuator = False Then
            ...
            strSql = "{project_code=" & "'" & projectID & "'" & " and task_id='CHKneedEvaluatedExp' and next_task='AssignValuatorExp'}"
            ...
            strSql = "{project_code=" & "'" & projectID & "'" & " and task_id='CHKneedEvaluatedExp' and next_task='ApplyCapitialEvaluatedExp'}"
            dsTempTaskTrans = WfProjectTaskTransfer.GetWfProjectTaskTransferInfo(strSql)
