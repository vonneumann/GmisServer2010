...
Public Class ImplIsValidateImpawned
    ...
    Public Function UseFlowTools(ByVal workFlowID As String, ByVal projectID As String, ByVal taskID As String, ByVal finishedFlag As String, ByVal userID As String) Implements IFlowTools.UseFlowTools
        ...
        '在Project_Guarantee_Form表中获取质押物记录
        strSql = "{project_code=" & "'" & projectID & "'" & " and guarantee_form='质押' and is_used=1}"
        ...
        If dsGuarantee.Tables(0).Rows.Count = 0 Then
            ' 将IsValidateImpawned到ValidateImpawned转移条件.F.
            strSql = "{project_code=" & "'" & projectID & "'" & " and task_id='IsValidateImpawned' and next_task ='ValidateImpawned'}"
            ...
            ' 将ValidateImpawned的状态置为F
            strSql = "{project_code=" & "'" & projectID & "'" & " and task_id ='ValidateImpawned'}"
        ...
        Else
            '否则
            ' 将IsValidateImpawned到ValidateImpawned转移条件.T.
            strSql = "{project_code=" & "'" & projectID & "'" & " and task_id='IsValidateImpawned' and next_task='ValidateImpawned'}"
            dsTempTaskTrans = WfProjectTaskTransfer.GetWfProjectTaskTransferInfo(strSql)
