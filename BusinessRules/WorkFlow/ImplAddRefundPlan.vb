...
Public Class ImplAddRefundPlan
    ...
    Public Function UseFlowTools(ByVal workFlowID As String, ByVal projectID As String, ByVal taskID As String, ByVal finishedFlag As String, ByVal userID As String) Implements IFlowTools.UseFlowTools
        ...
        For i = 0 To dsTempAccountDetail.Tables(0).Rows.Count - 1
            tmpReturnStartDate = DateAdd(DateInterval.Day, 3, dsTempAccountDetail.Tables(0).Rows(i).Item("date"))
        ...
        tmpDeadlineDate = CDate(dsTempLoanNotice.Tables(0).Rows(0).Item("end_date")).ToShortDateString()
        ...
        If count > 0 Then
            For j = 0 To count - 1
                dsTempTimingTask.Tables(0).Rows(j).Item("start_time") = tmpDeadlineDate 'DateAdd(DateInterval.Day, 6, tmpDeadlineDate)
        ...
        With newRow
            ...
            .Item("role_id") = "29"
            .Item("type") = "A"
            .Item("start_time") = tmpDeadlineDate 'DateAdd(DateInterval.Day, 6, tmpDeadlineDate)
            .Item("status") = "P"
            .Item("time_limit") = 0
            .Item("distance") = 7
            .Item("message_id") = 9
        ...
        '先删除原有的还款证明超时提示
        strSql = "{project_code='" & projectID & "' and task_id='RecordRefundCertificate' and type='A'}"
        dsTempTimingTask = WfProjectTimingTask.GetWfProjectTimingTaskInfo(strSql)
        For i = 0 To dsTempTimingTask.Tables(0).Rows.Count - 1
            dsTempTimingTask.Tables(0).Rows(i).Delete()
        Next
        ...
        With newRow
            .Item("workflow_id") = workFlowID
            .Item("project_code") = projectID
            .Item("task_id") = "RecordRefundCertificate"
            .Item("workflow_id") = workFlowID
            .Item("role_id") = "24"
            .Item("type") = "A"
            .Item("start_time") = DateAdd(DateInterval.Day, 6, tmpDeadlineDate)
            .Item("status") = "P"
            .Item("time_limit") = 0
            .Item("distance") = 1
            .Item("message_id") = 35
