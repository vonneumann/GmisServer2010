...
'判断是否需要启动确认收费标准任务
Public Class ImplIsValidateFinancingConsultingFee
    ...
    Public Function UseFlowTools(ByVal workFlowID As String, ByVal projectID As String, ByVal taskID As String, ByVal finishedFlag As String, ByVal userID As String) Implements IFlowTools.UseFlowTools
        ...
        strSql = "{project_code=" & "'" & projectID & "'" & " and task_id='IsValidateFinancingConsultingFee'}"
        ...
        If TotalTrialFeeIncome < TrialFeePayout Then
            For i = 0 To dsTempTaskTrans.Tables(0).Rows.Count - 1
                If dsTempTaskTrans.Tables(0).Rows(i).Item("next_task") = "ValidateFinancingConsultingRate" Then
        ...
        Else
            ...
            strSql = "{project_code=" & "'" & projectID & "'" & " and task_id in ('ValidateFinancingConsultingRate','FinancingConsultingFee')}"
    ...
    Private Function GetTotalTrialFeeIncome(ByVal ProjectID As String)
        ...
        Dim strSql As String = "{project_code=" & "'" & ProjectID & "'" & " and item_type='31'" & " and item_code='004'" & "}"
