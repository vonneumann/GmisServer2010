...
Public Class ImplOALoanApplication
    Implements IFlowTools

    '定义全局数据库连接对象
    Private conn As SqlConnection
    Private connOA As SqlConnection

    '定义事务
    Private ts As SqlTransaction
    Private tsOA As SqlTransaction
    ...
    Private commonqueryOA As CommonQuery
    ...
    Public Sub New(ByVal DbConnection As SqlConnection, ByRef trans As SqlTransaction)
        ...
        If conn.State = ConnectionState.Closed Then
            conn.Open()
        End If
        If connOA.State = ConnectionState.Closed Then
            connOA.Open()
        End If
    ...
    Public Function UseFlowTools(ByVal workFlowID As String, ByVal projectID As String, ByVal taskID As String, ByVal finishedFlag As String, ByVal userID As String) Implements IFlowTools.UseFlowTools
        ...
        '获取企业名称
        strSql = "select 企业名称 ,放款银行,担保金额,期限,担保费率,受益人,处理A角,处理B角 from queryProjectInfoForStatistics_Chinese where 项目编码='" + projectID + "'"
        ...
        '获取担保费率
        Dim dGuaranteeRate As Decimal = IIf(IsDBNull(dsTemp.Tables(0).Rows(0).Item("担保费率")), 0, dsTemp.Tables(0).Rows(0).Item("担保费率"))

        '获取受益人
        Dim strShouyr As String = dsTemp.Tables(0).Rows(0).Item("受益人")
        ...
        '创建主表字段
        Dim wrti(11) As WorkflowRequestTableField
        ...
        wrti(6).fieldName = "yinhmc"
        wrti(6).fieldValue = strBankName
        wrti(6).view = True
        wrti(6).edit = True
        ...
        wrti(7).fieldName = "danbje"
        wrti(7).fieldValue = strGuaranteeSum
        wrti(7).view = True
        wrti(7).edit = True
        ...
        wrti(8).fieldName = "danbfl"
        wrti(8).fieldValue = dGuaranteeRate
        wrti(8).view = True
        wrti(8).edit = True
        ...
        wrti(9).fieldName = "danbqx"
        wrti(9).fieldValue = strGuaranteeTerm
        wrti(9).view = True
        wrti(9).edit = True
        ...
        wrti(10).fieldName = "shouyr"
        wrti(10).fieldValue = strShouyr
        wrti(10).view = True
        wrti(10).edit = True
        ...
        wrti(11).fieldName = "pingshfj"
        wrti(11).fieldType = "http:" + strDocName
        wrti(11).fieldValue = "http://192.168.80.84/webservice_cgmis/tempdoc/" + strDocName
        wrti(11).view = True
        wrti(11).edit = True
        ...
        wri.creatorId = "56"
        wri.requestName = strCorporationName + "放款审批流程"
